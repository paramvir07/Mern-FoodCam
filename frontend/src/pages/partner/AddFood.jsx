...
const AddFood = () => {
    ...
    const handleSubmit = async(e) => {
        ...
        try {
            const response = await axios.post("http://localhost:3000/api/partner/addfood",
            {
                name: form.name,
        ...
        <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl mx-auto">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-4xl font-bold text-gray-800 mb-2">Add New Food Item</h1>
                    <p className="text-gray-600">Fill in the details to add a delicious new item to your menu</p>
                </div>
